...
interface MarketplaceContextType {
  ...
  currentPage: 'home' | 'store' | 'product' | 'dashboard' | 'admin' | 'checkout' | 'customer-orders' | 'lookbooks' | 'privacy' | 'terms' | 'studio';
...
export const MarketplaceProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [currentPage, setCurrentPage] = useState<'home' | 'store' | 'product' | 'dashboard' | 'admin' | 'checkout' | 'customer-orders' | 'lookbooks' | 'privacy' | 'terms' | 'studio'>('home');
