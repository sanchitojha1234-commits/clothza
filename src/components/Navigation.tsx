    ...
    <header className="sticky top-0 z-50 w-full glassmorphism transition-all duration-300 border-b border-border-main">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              className={`text-xs font-semibold tracking-wider uppercase transition-all duration-200 cursor-pointer flex items-center space-x-1 ${
                currentPage === 'studio' 
                  ? 'text-text-primary border-b-2 border-accent-main pb-0.5 font-bold' 
                  : 'text-text-secondary hover:text-text-primary pb-0.5'
              }`}
            >
              <span className="text-accent-main animate-pulse">✨</span>
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          <button
            onClick={navigateToStudio}
            className={`md:hidden px-2.5 py-1 rounded-full text-[11px] font-bold tracking-wider uppercase border transition-all cursor-pointer flex items-center space-x-0.5 ${
              currentPage === 'studio' 
